...
public class ChecksumCalculatorTest {
    @Test
    public void should_find_1_as_min_value() {
        assertThat(ChecksumCalculator.min("5   1   9   5")).isEqualTo(1);
    }

    @Test
    public void should_find_103_as_min_value() {
        assertThat(ChecksumCalculator.min("409\t194\t207\t470\t178\t454\t235\t333\t511\t103\t474\t293\t525\t372\t408\t428")).isEqualTo(103);
    }

    @Test
    public void should_find_9_as_max_value() {
        assertThat(ChecksumCalculator.max("5   1   9   5")).isEqualTo(9);
    }

    @Test
    public void should_find_525_as_max_value() {
        assertThat(ChecksumCalculator.max("409\t194\t207\t470\t178\t454\t235\t333\t511\t103\t474\t293\t525\t372\t408\t428")).isEqualTo(525);
    }

    @Test
    public void should_find_8_as_row_difference() {
        assertThat(ChecksumCalculator.difference("5   1   9   5")).isEqualTo(8);
    }

    @Test
    public void should_find_6_as_row_difference() {
        assertThat(ChecksumCalculator.difference("2\t4\t6\t8")).isEqualTo(6);
    }

    @Test
    public void should_find_18_as_checksum() {
        assertThat(ChecksumCalculator.checksum("5 1 9 5\n" +
                "7 5 3\n" +
                "2 4 6 8")).isEqualTo(18);
    }

    @Test
    public void should_find_44887_as_checksum() {
        assertThat(ChecksumCalculator.checksum("409\t194\t207\t470\t178\t454\t235\t333\t511\t103\t474\t293\t525\t372\t408\t428\n" +
                ...
                "3858\t202\t1141\t3458\t2507\t239\t199\t4400\t3713\t3980\t4170\t227\t3968\t1688\t4352\t4168")).isEqualTo(44887);
    }
}